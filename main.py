...
class CTGOHLCVGenerator:
    ...
    def generate_ohlcv(self, interval, start_time, end_time, title):
        ...
        print(f"Generated {len(ohlcv_data)} OHL CV records.")

# Main execution flow
if __name__ == "__main__":
    data_loader = CTGDataLoader('/add/path/to/your/data/folder')
    ...
    ohlcv_generator.generate_ohlcv("1d12h", "2024-09-16 09:30:00", "2024-09-17 16:00:00", "DayHr")
    ohlcv_generator.generate_ohlcv("1h30m", "2024-09-16 09:30:00", "2024-09-17 16:00:00", "HourMin")
    ohlcv_generator.generate_ohlcv("1m15s", "2024-09-16 09:30:00", "2024-09-17 16:00:00", "MinuteSec")
